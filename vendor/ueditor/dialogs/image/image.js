    ...
    UploadImage.prototype = {
        ...
        initUploader: function () {
            var _this = this,
                ...
                //actionUrl = window.__baseUrl+'learningcircle/uploadImage.byhealth',
                actionUrl = editor.getOpt('o_base')+"learningcircle/uploadImage.byhealth",
            ...
            uploader.on('uploadBeforeSend', function (file, data, header) {
                ...
                header['authenticationId'] = parent.window.authenticationId;
                header['userName'] = parent.window.userName;
            });
